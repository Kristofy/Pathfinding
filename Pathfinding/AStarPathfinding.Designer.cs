...
{
	partial class AStarPathfinding
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.heuristicTrackBar = new System.Windows.Forms.TrackBar();
			...
			((System.ComponentModel.ISupportInitialize)(this.heuristicTrackBar)).BeginInit();
			...
			// heuristicTrackBar
			// 
			this.heuristicTrackBar.Location = new System.Drawing.Point(628, 100);
			this.heuristicTrackBar.Maximum = 500;
			this.heuristicTrackBar.Minimum = 5;
			this.heuristicTrackBar.Name = "heuristicTrackBar";
			this.heuristicTrackBar.Size = new System.Drawing.Size(150, 45);
			this.heuristicTrackBar.TabIndex = 2;
			this.heuristicTrackBar.TickStyle = System.Windows.Forms.TickStyle.None;
			this.heuristicTrackBar.Value = 100;
			this.heuristicTrackBar.Scroll += new System.EventHandler(this.HeuristicsTrackBar);
			// 
			// resetButton
			// 
			...
			// heuristicLabel
			// 
			this.heuristicLabel.Font = new System.Drawing.Font("Microsoft Sans Serif", 14F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(238)));
			this.heuristicLabel.Location = new System.Drawing.Point(722, 74);
			this.heuristicLabel.Name = "heuristicLabel";
			this.heuristicLabel.Size = new System.Drawing.Size(100, 23);
			this.heuristicLabel.TabIndex = 7;
			this.heuristicLabel.Text = "1";
			// 
			// speedLabel
			// 
			...
			this.Controls.Add(this.heuristicTrackBar);
			...
			this.Name = "AStarPathfinding";
			this.Text = "AStarPathfinding";
			this.Load += new System.EventHandler(this.AStarPathfindingLoad);
			this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.AStarPathfindingKeyUp);
			((System.ComponentModel.ISupportInitialize)(this.heuristicTrackBar)).EndInit();
		...
		private System.Windows.Forms.TrackBar heuristicTrackBar;
